          ...
          <ul class={FacultyDashbaord.nav_links}>
            ...
            <li>
              <a href="#">
                ...
                <span class={FacultyDashbaord.link_name}>Comment</span>
              </a>
            </li>
            ...
            <li>
              <a href="#" id={FacultyDashbaord.archives_link}>
                <i
                  class="bi bi-archive"
                  id={FacultyDashbaord.archives_btnicon}
                ></i>
                <span
                  class={FacultyDashbaord.link_name}
                  id={FacultyDashbaord.archives_btn}
                >
                  Archives
                </span>
              </a>
            ...
            >
              ...
              <div class={FacultyDashbaord.search_syllabus_container}>
                <div class={FacultyDashbaord.search_syllabus}>
                  <i
                    class="bi bi-search"
                    id={FacultyDashbaord.search_top_icon}
                  ></i>
                  <input type="text" placeholder="Search Here..." />
                </div>
                ...
                <button
                  ...
                  id={FacultyDashbaord.upload_image}
                >
                  Upload Image
                </button>
              </div>
