...
export default function LongInput({
  ...
  return (
    ...
    >
      <span className="w-auto min-w-[15rem] text-zinc-600 font-medium flex items-center">
        {label}{" "}
      </span>
      <input
        form={form}
...
export function LongTextArea({
  ...
  return (
    ...
    >
      <span className="w-auto min-w-[15rem] text-zinc-600 font-medium flex items-start">
        {label}{" "}
      </span>
      <textarea
        form={form}
